...
\header {
  ...
  composer = "autor neznámý; noty poskytli lidé okolo poutního místa Skoky"
...
\markup\justify{
  ...
  Noty k antifoně mi laskavě zaslali organizátoři sboru, který
  na nahrávce zpívá, nápěv kantika jsem přepsal podle nahrávky.
  Obé jsem transponoval do základní polohy bez posuvek. \hspace #2 \italic{J.P.}
}